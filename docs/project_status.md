...
Current milestone: **A1 and A2 complete; A3 Coverage Verification + H1 Sample Audit next.**

The six-company analytical and Power BI work remains a **B1 Pilot snapshot**. It is retained as useful engineering evidence but does not satisfy the formal release sequence because A3 and Gate 1 have not been completed.
...
A0E PASSED
    ...
    -> A3 NEXT: all 40 Q1 candidates and all 14 event candidates
    -> Gate 1 PENDING
