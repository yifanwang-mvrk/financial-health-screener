...
- A larger, balanced sample showing leverage outcomes at least as persistent as operating outcomes would fail to support H1 — and the project's actual Tier B result already points that way (35.2% leverage vs. -11.9% operating), which is why it is reported as a counter-pattern rather than reframed as support.
