...
def _write_reports(
    ...
    gate2_lines = [
        ...
        "",
        f"A3 verified all {q2_summary['verified_event_count']} candidates and found {q2_summary['qualified_event_count']} that meet the event-count, eight-quarter, three-statement metadata, peer-control, PIT, and manual-cost criteria.",
        "",
